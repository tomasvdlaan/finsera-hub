...
export const crmManifest = defineManifest({
  ...
  entities: [
    { type: 'client', displayTemplate: '{name}', urlPattern: '/crm/clients/:id' },
    { type: 'contact', displayTemplate: '{name}', urlPattern: '/crm/contacts/:id' },
    { type: 'project', displayTemplate: '{name}', urlPattern: '/crm/projects/:id' },
  ],
